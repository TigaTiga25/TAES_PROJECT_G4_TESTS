...
WebUI.click(findTestObject('Object Repository/Page_Vite App/img_Orus_aspect-square size-full object-cover'))

WebUI.click(findTestObject('Object Repository/Page_Vite App/div_Give up_focusbg-accent focustext-accent_c27150'))
