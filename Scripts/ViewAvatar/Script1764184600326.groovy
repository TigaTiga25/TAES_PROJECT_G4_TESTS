...
WebUI.click(findTestObject('Object Repository/Page_Vite App/div_Profile_focusbg-accent focustext-accent_7e3aa4'))

WebUI.click(findTestObject('Object Repository/Page_Vite App/button_Your Avatar_text-slate-400 hovertext_0615ae'))
