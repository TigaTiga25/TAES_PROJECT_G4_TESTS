...
WebUI.click(findTestObject('Object Repository/Page_Vite App/img_Avatar Shop (7)_w-full aspect-square ro_6331c4'))

WebUI.click(findTestObject('Object Repository/Page_Vite App/button_Felix_inline-flex items-center justi_093709'))
