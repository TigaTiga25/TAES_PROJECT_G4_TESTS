...
class PlayACard {
	...
	def I_should_see_it_in_the_board() {
		WebUI.verifyElementPresent(findTestObject('Object Repository/GameBoardPage/playerCardInBoard'), 0)
		println "Then->I should see it in the board"
	}
}